            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-manrope font-normal text-gray-900 mb-2">Specialist Cleaning</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-manrope font-normal text-gray-900 mb-2">Surface Safe</h3>
                    <p className="text-gray-600 font-manrope">
                      Our cleaning methods are safe for PVC materials and won't cause damage or discoloration to your fascias, soffits, or gutters.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-manrope">
                      Professional cleaning that removes stubborn dirt and grime, leaving your PVC surfaces looking clean and bright for longer.
                    </p>
                  </div>
                </div>
              </div>

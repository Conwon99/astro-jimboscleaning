...
interface GutterCleaningCityProps {
  city: string;
}

const GutterCleaningCity = ({ city }: GutterCleaningCityProps) => {
  ...
  const relatedServices = [
    ...
    { name: "PVC White Cleaning", link: `/services/pvc-white-cleaning/${city.toLowerCase()}` },
    { name: "Window Cleaning", link: `/services/window-cleaning/${city.toLowerCase()}` }
  ];

  const categoryLinks = [
    { name: "Gutter Cleaning Service", link: `/categories/gutter-cleaning-service/${city.toLowerCase()}` }
  ];
  ...
  return (
    <div className="font-manrope">
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-4xl md:text-5xl font-manrope font-normal text-gray-900 mb-6">
              Looking For A Gutter Cleaning In {city}?
            </h1>
            <p className="text-xl text-gray-600 font-manrope mb-8 leading-relaxed">
              Professional gutter cleaning services in {city}, Ayrshire. Thorough gutter cleaning to keep your drainage systems clear and functional.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-6">Why Choose Our Gutter Cleaning in {city}?</h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-manrope font-normal text-gray-900 mb-2">Thorough Cleaning</h3>
                    <p className="text-gray-600 font-manrope">We remove leaves, debris, moss, and blockages to prevent water damage.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-[#526bb0] rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-xl font-manrope font-normal text-gray-900 mb-2">Safe & Professional</h3>
                    <p className="text-gray-600 font-manrope">Our experienced team uses safe methods and professional equipment.</p>
                  </div>
                </div>
              </div>
            </div>
            <div>
              <Card className="bg-gray-50">
                ...
                <CardContent>
                  <p className="text-gray-600 font-manrope mb-4">We provide gutter cleaning in {city} and across Ayrshire:</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto max-w-4xl px-4">
          <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-6">Related Categories</h2>
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            {categoryLinks.map((category, index) => (
              <a key={index} href={category.link} className="block p-4 bg-white rounded-lg hover:shadow-lg transition-shadow duration-300">
                <h3 className="text-lg font-manrope font-normal text-gray-900 mb-2">{category.name} {city}</h3>
                <p className="text-gray-600 font-manrope text-sm">View all {category.name.toLowerCase()} services in {city}</p>
              </a>
            ))}
          </div>
      ...
      <section id="contact" className="py-16 bg-white">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-4">Ready to Clean Your Gutters in {city}?</h2>
            <p className="text-xl text-gray-600 font-manrope">Contact us today for a free quote on gutter cleaning services in {city}.</p>
          </div>
...
export default GutterCleaningCity;

...
interface RoofSteamCleaningCityProps {
  city: string;
}

const RoofSteamCleaningCity = ({ city }: RoofSteamCleaningCityProps) => {
  ...
  const relatedServices = [
    ...
    { name: "Render Softwashing", link: `/services/render-softwashing/${city.toLowerCase()}` }
  ];
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-4xl md:text-5xl font-manrope font-normal text-gray-900 mb-6">
              Looking For A Roof Steam Cleaning In {city}?
            </h1>
            <p className="text-xl text-gray-600 font-manrope mb-8 leading-relaxed">
              Professional roof steam cleaning services in {city}, Ayrshire. Safe and effective steam cleaning to remove moss, algae, and dirt from roof tiles.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-6">Why Choose Our Roof Steam Cleaning in {city}?</h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-manrope">Steam cleaning safely removes moss, algae, and dirt without damaging your roof tiles.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-[#526bb0] rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-xl font-manrope font-normal text-gray-900 mb-2">Environmentally Friendly</h3>
                    <p className="text-gray-600 font-manrope">Our steam cleaning methods are safe for the environment and your property.</p>
                  </div>
                </div>
              </div>
            </div>
            <div>
              <Card className="bg-gray-50">
                ...
                <CardContent>
                  <p className="text-gray-600 font-manrope mb-4">We provide roof steam cleaning in {city} and across Ayrshire:</p>
      ...
      <section id="contact" className="py-16 bg-white">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-4">Ready to Clean Your Roof in {city}?</h2>
            <p className="text-xl text-gray-600 font-manrope">Contact us today for a free quote on roof steam cleaning services in {city}.</p>
          </div>
...
export default RoofSteamCleaningCity;

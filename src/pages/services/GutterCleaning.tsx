              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-manrope">
                      We thoroughly remove leaves, twigs, moss, and other debris that can block your gutters and cause water damage.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-manrope">
                      We use professional-grade equipment and techniques to safely and efficiently clean your gutters.
                    </p>
                  </div>
                </div>
              </div>

...
interface WindowCleaningCityProps {
  city: string;
}

const WindowCleaningCity = ({ city }: WindowCleaningCityProps) => {
  ...
  const categoryLinks = [
    { name: "Window Cleaning Service", link: `/categories/window-cleaning-service/${city.toLowerCase()}` },
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-manrope font-normal text-gray-900 mb-6">
              Looking For A Window Cleaning In {city}?
            </h1>
            <p className="text-xl text-gray-600 font-manrope mb-8 leading-relaxed">
              Professional window cleaning services in {city}, Ayrshire. Streak-free window cleaning for sparkling results every time. 
              Serving homes and businesses across {city} and surrounding areas.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-6">
                Why Choose Our Window Cleaning in {city}?
              </h2>
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-manrope">
                      We offer regular window cleaning schedules to keep your windows looking their best year-round in {city}.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Card className="bg-gray-50">
                ...
                <CardContent>
                  <p className="text-gray-600 font-manrope mb-4">
                    We provide window cleaning services in {city} and across Ayrshire:
                  </p>
                  <div className="space-y-2">
                    <a
                      href={`/locations/${city.toLowerCase()}`}
                      className="text-[#526bb0] hover:text-blue-700 font-manrope font-normal hover:underline block"
                    >
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            {categoryLinks.map((category, index) => (
              <a
                key={index}
                href={category.link}
                className="block p-4 bg-white rounded-lg hover:shadow-lg transition-shadow duration-300"
              >
                <h3 className="text-lg font-manrope font-normal text-gray-900 mb-2">
                  {category.name} {city}
                </h3>
                <p className="text-gray-600 font-manrope text-sm">
                  View all {category.name.toLowerCase()} services in {city}
                </p>
              </a>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {relatedServices.map((service, index) => (
              ...
              >
                ...
                <p className="text-gray-600 font-manrope text-sm">
                  Learn more about our {service.name.toLowerCase()} services in {city}.
                </p>
              </a>
            ))}
          </div>
        ...
        <div className="container mx-auto max-w-4xl px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-4">
              Ready to Clean Your Windows in {city}?
            </h2>
            <p className="text-xl text-gray-600 font-manrope">
              Contact us today for a free quote on window cleaning services in {city}.
            </p>
          </div>
...
export default WindowCleaningCity;

...
interface WindowCleaningServiceCategoryProps {
  city: string;
}

const WindowCleaningServiceCategory = ({ city }: WindowCleaningServiceCategoryProps) => {
  ...
  const services = [
    ...
    { 
      name: "Window Washing", 
      link: `/services/window-washing/${city.toLowerCase()}`,
      description: "Professional window washing services for streak-free, sparkling results."
    },
    { 
  ...
  const nearbyAreas = [
    { name: "Irvine", link: "/categories/window-cleaning-service/irvine" },
    { name: "Kilmarnock", link: "/categories/window-cleaning-service/kilmarnock" },
    { name: "Ayr", link: "/categories/window-cleaning-service/ayr" },
    { name: "Troon", link: "/categories/window-cleaning-service/troon" },
    { name: "Prestwick", link: "/categories/window-cleaning-service/prestwick" }
        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-manrope font-normal text-gray-900 mb-6">
              Looking For A Window Cleaning Service In {city}?
            </h1>
            <p className="text-xl text-gray-600 font-manrope mb-8 leading-relaxed">
              Professional window cleaning service in {city}, Ayrshire. We provide expert glass cleaning, gutter cleaning, 
              window cleaning, power washing, and rooftop cleaning services for homes and businesses across {city} and surrounding areas.
            </p>
      ...
      <section id="services" className="py-16 bg-white">
        <div className="container mx-auto max-w-4xl px-4">
          <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-8 text-center">
            Our Window Cleaning Services in {city}
          </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-manrope font-normal text-gray-900 mb-6">
                Why Choose Our Window Cleaning Services in {city}?
              </h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-manrope">
                      Our experienced team provides professional window cleaning services using safe, effective methods and quality equipment.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-manrope">
                      We offer flexible scheduling and regular maintenance programs to keep your windows looking their best year-round.
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto max-w-4xl px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 font-manrope">
              Contact us today for a free quote on professional window cleaning services in {city}.
            </p>
          </div>
...
export default WindowCleaningServiceCategory;
